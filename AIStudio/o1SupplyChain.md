# Supply Chain fulfilment using o1-preview

## Introduction

- Supply Chain fulfilment using o1-preview.
- Ability to use reasoning to find the best posible vendor to fulfil.
- Consider location, cost, quality and delivery time.
- Consider global supply chain and local supply chain.
- Ability to apply global sourcing strategies.
- Ability to provide constraints and preferences.
...
- Azure Open AI
- o1-preview access.
- Deploy the model in Azure Open AI Studio or Azure AI Studio

## Steps

- First create a sample data set.
- i am using o1 to create a complex supplychain dataset across globe.
- First create the prompt with data included.
- here is the prompt and data includes
...
- submit and wait for the model to respond.

### output

- Here is the output of the model

![info](https://github.com/balakreshnan/Samples2025/blob/main/AIStudio/images/o1supplychain-1.jpg 'RagChat')
![info](https://github.com/balakreshnan/Samples2025/blob/main/AIStudio/images/o1supplychain-2.jpg 'RagChat')
![info](https://github.com/balakreshnan/Samples2025/blob/main/AIStudio/images/o1supplychain-3.jpg 'RagChat')
![info](https://github.com/balakreshnan/Samples2025/blob/main/AIStudio/images/o1supplychain-4.jpg 'RagChat')
